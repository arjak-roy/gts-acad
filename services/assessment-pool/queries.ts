...
export async function listAssessmentPoolsService(filters?: {
  ...
  return pools.map((p) => ({
    ...
    passCriteriaConfig: (p.passCriteriaConfig as AssessmentPoolListItem["passCriteriaConfig"]) ?? null,
...
export async function getAssessmentPoolByIdService(poolId: string): Promise<AssessmentPoolDetail | null> {
  ...
  return {
    ...
    passCriteriaConfig: (pool.passCriteriaConfig as AssessmentPoolDetail["passCriteriaConfig"]) ?? null,
