...
/**
 * Persists attendance records for a batch session in an idempotent way.
 * Falls back to deterministic mock behavior when no database is configured.
 * Recomputes readiness after updates so placement signals stay accurate.
 */
