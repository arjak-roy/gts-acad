...
import { getLanguageLabPronunciationAnalyticsService } from "@/services/language-lab-service";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const analytics = await getLanguageLabPronunciationAnalyticsService(input);
