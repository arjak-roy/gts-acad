...
import { getLanguageLabWordProgressAnalyticsService } from "@/services/language-lab-service";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const analytics = await getLanguageLabWordProgressAnalyticsService(input);
