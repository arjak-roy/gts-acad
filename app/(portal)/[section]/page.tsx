...
const sectionConfig = {
  ...
  "trainer-sessions": {
    ...
    description: "View trainer session assignments, calendar stats, and manage trainer-level scheduling.",
    accent: "Faculty scheduling",
    summary: "Trainer session allocation, conflict detection, and calendar overview.",
    metrics: [],
    highlights: [],
    tableTitle: "Sessions",
    tableDescription: "Trainer-assigned sessions.",
    tableColumns: [],
    tableRows: [],
    primaryAction: "",
    secondaryAction: "",
  ...
  "logs-actions": {
    title: "Logs & Actions",
    description: "Operational audit and delivery actions across batches, candidates, courses, and email workflows.",
    accent: "Execution telemetry",
    summary: "Observe operational activity and resolve failed deliveries from a single console.",
    metrics: [],
    highlights: [],
    tableTitle: "Logs",
    tableDescription: "Explore module logs and execute retry actions for failed email deliveries.",
    tableColumns: [
